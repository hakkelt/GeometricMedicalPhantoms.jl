    ...
    for i in 1:nx
        for j in 1:ny
            ...
            if is_inside && !is_near_boundary
                ...
                elseif !isapprox(val, intensity, atol=1e-6)
...
@testset "RotatedEllipsoid Tests" begin
    ...
    @testset "get_rotation_matrix - Z-Y-X Euler angles" begin
        ...
        @test R_axial_matrix ≈ R_expected atol=1e-10
        ...
        @test R_coronal_matrix ≈ R_expected_coronal atol=1e-10
        ...
        @test R_sagittal_matrix ≈ R_expected_sagittal atol=1e-10
    end
    ...
    @testset "get_rotation_matrix - identity rotation" begin
        ...
        @test R_identity_matrix ≈ I(3) atol=1e-10
    end
